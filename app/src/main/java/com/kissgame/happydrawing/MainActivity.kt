package com.kissgame.happydrawing
...
class MainActivity : AppCompatActivity() {
    ...
    private var mSelectedPickColor = 0
...
//        val ibGallery: ImageButton = findViewById(R.id.ibGalary)
...
//        }
        ...
        val ibColorPick = findViewById<ImageButton>(R.id.ibColorPick)
        ibColorPick.setOnClickListener {
            openColorPick()
        }
    ...
    fun paintClicked(view: View) {
        if (view !== mImageButtonCurrentPaint) {
            ...
            if (colorTag != getString(R.string.color_pick)) {
    ...
    private fun openColorPick(){
        // the AmbilWarnaDialog callback needs 3 parameters
        // one is the context, second is default color,
        val colorPickerDialogue = AmbilWarnaDialog(this, mSelectedPickColor,
            object : OnAmbilWarnaListener {
                ...
                override fun onOk(dialog: AmbilWarnaDialog?, color: Int) {
                    ...
                    // color picker dialog
                    mSelectedPickColor = color
                    val hexColor = String.format("#%06X", 0xFFFFFF and mSelectedPickColor)
            ...
            if (mBitmap != null) {
                ...
                try {
                    ...
                    runOnUiThread {
                        ...
                        if (!result.isEmpty()) {
                            Snackbar.make(parentLayout!!, "File saved successfully :$result", Snackbar.LENGTH_LONG).show()
                            //shareImage(result)
                            shareImage(FileProvider.getUriForFile(baseContext,"com.kissgame.happydrawing.fileprovider",f))
                        } else {
                            Snackbar.make(parentLayout!!, "Something went wrong while saving the file.", Snackbar.LENGTH_LONG).show()
                        }
                    }
                } catch (e: Exception) {
                    result = ""
